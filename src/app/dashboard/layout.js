...
export default function DashboardLayout({ children }) {
    ...
    return (
        <div className='min-h-screen bg-slate-50 dark:bg-zinc-950'>
            ...
            <div className='flex'>
                {/* SIDEBAR */}
                <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-zinc-900 border-r border-slate-200 transform transition-transform duration-200 ease-in-out lg:translate-x-0 lg:static ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
