        ...
        <DashboardShell>
            <div className="space-y-8">
                <div>
                    ...
                    <p className="opacity-60">Generación de instrumentos, evaluaciones y gestión disciplinaria.</p>
                </div>
                                ...
                                {activeTool === "CONDUCTA" && (
                                    <>
                                        ...
                                        <div className="form-control">
                                            ...
                                            <textarea className="textarea textarea-bordered" placeholder="¿Qué sucedió exactamente?" onChange={e => setInputData({ ...inputData, falta: e.target.value })} />
                                        </div>
                                    </>
                                )}
                            </div>
