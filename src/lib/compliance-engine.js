...
const ARTICLES = {
    "REA-2024": {
        "cotidiano": "Artículo 23: El Trabajo Cotidiano se evalúa mediante escalas de desempeño y rúbricas.",
        "pruebas": "Artículo 45: La prueba escrita debe basarse en la Tabla de Especificaciones.",
        "adecuacion": "Artículo 46: Las pruebas para estudiantes con adecuación significativa deben ajustarse al nivel de funcionamiento."
    },
    "ETP-2023": {
        "practica": "Artículo 12: La Práctica Profesional Supervisada es requisito de graduación (320 horas).",
...
export const generateComplianceSheet = (planType, modality) => {
    const citations = [];
    const articles = modality === 'Técnica' ? { ...ARTICLES["REA-2024"], ...ARTICLES["ETP-2023"] } : ARTICLES["REA-2024"];

    if (planType.includes('Prueba')) {
        citations.push(articles.pruebas);
        citations.push("Transitorio II: La distribución porcentual se rige por los nuevos lineamientos 2024.");
    }
