...
interface RutaMediacion {
    tipo: string;
    docente: string;
    estudiante: string;
    inclusion: string | { [key: string]: string };
}

interface MediationDeckProps {
    rutas: RutaMediacion[];
}

const getIconForRoute = (tipo: string) => {
...
const getInclusionText = (inclusion: string | any): string => {
...
export const MediationDeck: React.FC<MediationDeckProps> = ({ rutas }) => {
