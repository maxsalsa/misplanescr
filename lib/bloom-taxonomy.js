...
export const ACTIVITY_TYPES = [
  {
    id: "introduccion",
    name: "Introducción",
    description: "Activación de conocimientos previos",
    icon: "🎯",
  },
  {
    id: "desarrollo",
    name: "Desarrollo",
    description: "Construcción del aprendizaje",
    icon: "📚",
  },
  {
    id: "cierre",
    name: "Cierre",
    description: "Consolidación y reflexión",
    icon: "✅",
  },
  {
    id: "proyecto",
    name: "Proyecto",
    description: "Aplicación práctica integrada",
    icon: "🚀",
  },
  {
    id: "evaluacion",
    name: "Evaluación",
    description: "Verificación de aprendizajes",
    icon: "📊",
  },
  {
    id: "laboratorio",
    name: "Laboratorio",
    description: "Práctica guiada en taller",
    icon: "🔬",
  },
  {
    id: "reto",
    name: "Reto/Challenge",
    description: "Desafío de aplicación",
    icon: "🏆",
  },
  {
    id: "gamificado",
    name: "Gamificado",
    description: "Aprendizaje lúdico",
    icon: "🎮",
  },
  {
    id: "colaborativo",
  ...
  },
  {
    id: "investigacion",
    name: "Investigación",
    description: "Búsqueda y análisis",
    icon: "🔍",
  },
];
