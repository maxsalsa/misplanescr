...
export const ADMIN_TEMPLATES = {
  REFERENCIA: {
    ...
    fields: [
      "Nombre Estudiante",
      "Sección",
      "Motivo (Conductual/Académico)",
      "Acciones Previas Docente",
      "Observaciones",
    ],
  ...
  ADECUACION: {
    ...
    fields: [
      "Diagnóstico",
      "Fonctionamiento Actual",
      "Metas Anuales",
      "Apoyos Específicos",
      "Criterios de Evaluación Modificados",
    ],
...
export function generateCivicProgram(dateKey) {
  ...
  if (!event)
    return {
      title: "Acto Cívico Regular",
      protocol: ["Himno Nacional", "Mensaje del Director"],
    };
