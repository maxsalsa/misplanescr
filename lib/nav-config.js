  ...
  student: [
    {
      ...
      items: [
        ...
        {
          label: "Juegos & Quizzes",
          href: "/dashboard/student/games",
          icon: Gamepad2,
          color: "text-purple-500",
        },
        {
          label: "Biblioteca de Repaso",
  ...
  family: [
    {
      ...
      items: [
        {
          label: "Resumen del Estudiante",
          href: "/dashboard/family",
          icon: LineChart,
        },
        {
          label: "Asistencia",
          href: "/dashboard/family/attendance",
          icon: UserCheck,
          color: "text-blue-500",
        },
      ],
