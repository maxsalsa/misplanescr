...
export const NEBULA_INVENTORY = {
  ENGINEERING: {
    ...
    focus: "Pascal's Principle",
    type: "MAKER",
  },
  TOURISM: {
    title: "Roleplay: Tour Guiding",
    focus: "Oral Fluency",
    type: "ROLEPLAY",
  },
  CULTURE: {
    title: "Mascaradas Tradicionales",
    focus: "Art & Heritage",
    type: "ART",
  },
  BUSINESS: {
  ...
  SCIENCE: {
    title: "Feria Científica: Prototipo",
  ...
  return {
    ...
    levels: [
      { score: 1, label: "Inicial", desc: "Muestra avances incipientes." },
      {
        score: 2,
        label: "Intermedio",
        desc: "Muestra avances significativos pero requiere apoyo.",
      },
      {
        score: 3,
        label: "Avanzado",
        desc: "Logra el indicador de manera autónoma.",
      },
    ],
    warning:
      "⚠️ PROHIBIDO usar escalas 1-5 o 1-10 para desempeño formativo/sumativo en guías de trabajo.",
  };
}
...
export function validateScaleCompliance(maxScore) {
  ...
  return {
    valid: false,
    correction:
      "La escala debe ser 1 (Inicial) a 3 (Avanzado). Ajuste inmediatamente.",
  };
}
