...
export const PEDAGOGY_MATRIX = {
  HARD_TECH: {
    ...
    color: "slate",
    moments: [
      { name: "1. CONEXIÓN", desc: "Análisis de Caso Forense / Fallo Real", dua: "Captar interés (7.1)" },
      { name: "2. COLABORACIÓN", desc: "Code Review / Diseño de Arquitectura en Equipo", dua: "Comunidad (8.3)" },
      { name: "3. CONSTRUCCIÓN", desc: "Laboratorio Técnico (Coding/Config)", dua: "Acción física (4.1)", component: "CodeMockup" },
      { name: "4. CLARIFICACIÓN", desc: "Debugging y optimización.", dua: "Autoevaluación (9.3)" }
    ],
    evaluation: {
  ...
  SCIENCE: {
    ...
    color: "emerald",
    moments: [
      { name: "1. FOCALIZACIÓN", desc: "Pregunta Investigable / Problema del Entorno", dua: "Relevancia (7.2)" },
      { name: "2. EXPLORACIÓN", desc: "Recolección de Datos / Trabajo de Campo", dua: "Percepción (1.2)" },
      { name: "3. CONTRASTACIÓN", desc: "Análisis de Resultados vs Teoría", dua: "Comprensión (3.3)" },
      { name: "4. APLICACIÓN", desc: "Resolución del Problema", dua: "Transferencia (6.2)" }
    ],
    evaluation: {
  ...
  SERVICE: {
    ...
    color: "rose",
    moments: [
      { name: "1. ENGANCHE", desc: "Video de 'Mal Servicio' para análisis", dua: "Opciones de percepción" },
      { name: "2. ENSAYO", desc: "Diseño de Guiones y Protocolos", dua: "Expresión y comunicación" },
      { name: "3. SIMULACIÓN", desc: "Roleplay: Atención al Cliente en Escenario", dua: "Acción (4.2)" },
      { name: "4. REFLEXIÓN", desc: "Video-feedback y análisis de lenguaje corporal", dua: "Monitoreo (6.4)" }
    ],
    evaluation: {
  ...
  INDUSTRIAL: {
    ...
    moments: [
      ...
      { name: "2. DEMOSTRACIÓN", desc: "Modelado de uso de maquinaria", dua: "Representación" },
      { name: "3. PRÁCTICA", desc: "Ejecución supervisada", dua: "Acción física" },
  ...
  ACADEMIC: {
    ...
    color: "blue",
    moments: [
      { name: "1. CONEXIÓN", desc: "Activación de conocimientos previos", dua: "Conocimiento previo" },
      { name: "2. COLABORACIÓN", desc: "Discusión socrática / Análisis de textos", dua: "Colaboración" },
      { name: "3. CONSTRUCCIÓN", desc: "Resolución de problemas / Producción textual", dua: "Práctica graduada" },
      { name: "4. CIERRE", desc: "Síntesis y metacognición", dua: "Auto-reflexión" }
    ]
  }
};
