...
export const DASHBOARD_STATS = {
    ...
    alerts: [
      {
        id: 1,
        type: "warning",
        message: "Grupo 7-B bajo rendimiento en Matemáticas",
        action: "Ver Detalles",
      },
      {
        id: 2,
        type: "info",
        message: "Reunión de personal programada para el viernes",
        action: "Agendar",
      },
      {
        id: 3,
        type: "success",
        message: "Planeamiento de Informática aprobado",
        action: "Descargar",
      },
    ],
    performanceByGroup: [
  ...
  student: {
    ...
    todoList: [
      {
        id: 1,
        title: "Resolver Práctica de Álgebra",
        subject: "Matemáticas",
        deadline: "Mañana",
        status: "urgent",
      },
...
export const APPOINTMENTS_MOCK = [
  ...
  },
  {
    ...
    date: "2025-02-16",
    time: "02:00 PM",
    reason: "justificación de ausencia",
    status: "approved",
  },
];
