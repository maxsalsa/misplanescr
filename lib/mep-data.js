...
export const MEP_DATA = {
    ...
    "Educación Primaria (I y II Ciclos)": {
        "1": { "I Semestre": { "Español": [], "Matemáticas": [], "Ciencias": [], "Estudios Sociales": [], "Inglés": [] } },
        "2": { "I Semestre": { "Español": [], "Matemáticas": [], "Ciencias": [], "Estudios Sociales": [], "Inglés": [] } },
        "3": { "I Semestre": { "Español": [], "Matemáticas": [], "Ciencias": [], "Estudios Sociales": [], "Inglés": [] } },
        "4": {
            "I Semestre": {
                "Estudios Sociales": [
                    {
        ...
        "5": { "I Semestre": { "Español": [], "Matemáticas": [], "Ciencias": [], "Estudios Sociales": [], "Inglés": [] } },
        "6": { "I Semestre": { "Español": [], "Matemáticas": [], "Ciencias": [], "Estudios Sociales": [], "Inglés": [] } }
    },
    ...
    "Secundaria Académica (III Ciclo y Div.)": {
        ...
        "8": { "I Semestre": { "Español": [], "Matemáticas": [], "Ciencias": [], "Estudios Sociales": [], "Inglés": [] } },
        "9": { "I Semestre": { "Español": [], "Matemáticas": [], "Ciencias": [], "Estudios Sociales": [], "Inglés": [] } },
        "10": {
            "I Semestre": {
                "Matemáticas": [
                    {
        ...
        "11": { "I Semestre": { "Español": [], "Matemáticas": [], "Biología": [], "Física": [], "Química": [], "Filosofía": [] } }
    },
    ...
    // -------------------------------------------------------------------------
    "Secundaria Nocturna": {
        "Nivel 1": { "I Semestre": { "Español": [], "Matemáticas": [], "Estudios Sociales": [], "Ciencias": [] } },
        "Nivel 2": { "I Semestre": { "Español": [], "Matemáticas": [], "Biología": [], "Química": [] } },
        "Nivel 3": { "I Semestre": { "Español": [], "Matemáticas": [], "Biología": [], "Física": [] } }
    },
    ...
    // -------------------------------------------------------------------------
    "IPEC": {
        "Cursos Libres": { "I Semestre": { "Manipulación de Alimentos": [], "Inglés Básico": [] } },
        "Técnico Medio": { "I Semestre": { "Secretariado": [], "Contabilidad": [] } }
    },
    ...
    // -------------------------------------------------------------------------
    "CINDEA": {
        "I Nivel (Primaria)": { "I Semestre": { "Formación Básica": [] } },
        "II Nivel (7°-9°)": { "I Semestre": { "Español": [], "Matemáticas": [], "Ciencias": [] } },
        "III Nivel (10°-11°)": { "I Semestre": { "Español": [], "Matemáticas": [], "Biología": [] } }
    }
};
