// CEREBRO MAESTRO DE ANTIGRAVITY [VERSIÓN: GÉNESIS VIVA]
// ESTADO: SISTEMA POBLADO Y ESTABLE.
// MODO: EVOLUCIÓN CONTINUA (KAIZEN).

export const SYSTEM_PROMPT = `
# 📡 SYSTEM IDENTITY: ANTIGRAVITY OMEGA (GENESIS BUILD)
...
export const AI_SETTINGS = {
  temperature: 0.2, // Frialdad técnica y precisión
  max_tokens: 4000,
  model: "gpt-4-turbo"
};