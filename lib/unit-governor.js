...
export const validateUnitTimeBalance = (unitTotalHours, proposedActivities) => {
  ...
  return {
    ...
    alert:
      variance < 0
        ? "¡ALERTA TÉCNICA! El plan excede el tiempo reglamentario."
        : null,
  };
};

// 3. SOVEREIGNTY SEAL
export const SOVEREIGN_FOOTER =
  "Planificación Integral de Unidad - Tecnología MisPlanesCR (Max Salazar Sánchez - 60906359)";
