        ...
        slides: [
            {
                number: 1,
                type: "Title",
                content: { title: topic, subtitle: "Exploración Docente", note: "Docente: Use esta slide para activar conocimientos previos." },
                visual_prompt: "Abstract background with educational icons."
            },
            {
                number: 2,
                type: "Hook",
                content: { headline: "¿Sabías que...?", body: ["Dato curioso 1", "Dato curioso 2"], note: "Genere debate con estos datos." },
                visual_prompt: "High impact image related to the curious fact."
            },
            {
                number: 3,
                type: "Core Concept",
                content: { headline: "Concepto Clave", body: "Definición clara y concisa.", note: "Pida a los estudiantes que parafraseen." },
                visual_prompt: "Diagram or Schema of the concept."
            },
            {
                number: slideCount,
                type: "Closure",
                content: { headline: "Conclusiones", body: "Resumen de puntos principales.", note: "Tiquete de salida: ¿Qué me llevo hoy?" },
...
export function curateVideoResource(query) {
    ...
    return {
        ...
        instruction: "Docente, asigne este video como tarea previa (Aula Invertida) o proyéctelo para iniciar el debate.",
        viewing_guide: [
...
export function designInfographic(concept) {
    return {
        ...
        text_structure: {
            header: concept,
            steps: ["Paso 1: Definición", "Paso 2: Características", "Paso 3: Ejemplo Real"],
...
export function generateGamifiedReview(topic) {
    return {
        ...
        questions: [
            { q: "¿Cuál es la característica principal de...?", options: ["A", "B", "C"], correct: "A", time: "20s" },
