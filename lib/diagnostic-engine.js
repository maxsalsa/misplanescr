...
export function analyzeDiagnosticState(results) {
    ...
    if (percentage < 60) {
        return {
            ...
            strategies: ["Tutoría entre pares", "Material concreto", "Refuerzo extra-clase"],
        ...
        return {
            ...
            strategies: ["Proyectos de investigación", "Roles de liderazgo (Monitor)", "Actividades de mayor complejidad"],
