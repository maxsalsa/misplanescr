  ...
  MATH: [
    {
      ...
      scenario: "Project: Baking a Cake (Adjusting Recipes)",
      domain: "Culinary Arts",
    },
    {
      topic: "Statistics",
      scenario: "Simulation: Market Research for a Start-up",
      domain: "Business",
    },
    {
      topic: "Algebra",
      scenario: "Project: Construction Budgeting for a Dog House",
      domain: "Engineering",
    },
  ],
  SCIENCE: [
    {
      topic: "Ecosystems",
      scenario: "Project: Designing a Self-Sustaining Terrarium",
      domain: "Ecology",
    },
    {
      topic: "Chemical Reactions",
      scenario: "Forensic Lab: Analyzing 'Crime Scene' Substances",
      domain: "Forensics",
    },
    {
      topic: "Human Body",
      scenario: "First Aid Course: CPR and Injury Response",
      domain: "Health",
    },
  ],
  SOCIAL_STUDIES: [
    {
      topic: "Democracy",
      scenario: "Simulation: Town Hall Meeting on Local Traffic",
      domain: "Civics",
    },
    {
      topic: "Geography",
      scenario: "Project: Planning a Eco-Tourism Trip",
      domain: "Tourism",
    },
  ],
  LANGUAGE: [
    {
      topic: "Persuasion",
      scenario: "Shark Tank Pitch: Selling a Sustainable Product",
      domain: "Business",
    },
    {
      topic: "Narrative",
      scenario: "Podcast Production: 'Stories of my Community'",
      domain: "Media",
    },
  ],
};
...
export function infuseLifeSkills(subject, topic) {
  ...
  if (LIFE_COMPETENCIES.COEXISTENCE.trigger_subjects.includes(subject)) {
    ...
    LIFE_COMPETENCIES.SUSTAINABILITY.trigger_subjects.includes(subject)
  ) {
  ...
  const match = scenarios.find(
    (s) => topic.includes(s.topic) || s.topic.includes(topic),
  ) || {
    scenario: `Project: Applying ${topic} to solving a community problem`,
    domain: "General Life",
  };
