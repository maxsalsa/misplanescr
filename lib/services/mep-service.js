...
const MEP_DATA = {
  ...
  programs: [
    ...
    { id: "tur-10", name: "Turismo Ecológico 10°", level: "10mo", type: "TECNICA" },
    { id: "con-10", name: "Contabilidad 10°", level: "10mo", type: "TECNICA" },
    { id: "inf-10", name: "Informática (Desarrollo) 10°", level: "10mo", type: "TECNICA" },
    { id: "rob-club", name: "Taller de Robótica", level: "Club", type: "TALLER" }
  ]
};
