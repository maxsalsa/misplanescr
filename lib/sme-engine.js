...
const DOMAIN_LOGIC = {
  ...
  [DOMAINS.TECHNICAL]: {
    ...
    materials_example: [
      "Equipo de Protección Personal (Casco/Lentes)",
...
export function getDomainConfig(domainKey) {
  return (
    DOMAIN_LOGIC[domainKey] || {
      focus: "Mediación General",
      resources: ["Libro de Texto", "Presentación Multimedia"],
      evaluation: {
        instrument: "Rúbrica Estándar",
        criteria: ["Comprensión", "Aplicación"],
      },
    }
  );
}
