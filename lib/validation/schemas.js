...
export const LessonPlanSchema = z.object({
  ...
  subject: z.enum([
    "Matemáticas", "Español", "Ciencias", "Estudios Sociales", "Inglés", 
    "Ciberseguridad", "Turismo", "Contabilidad", "Ejecutivo", "Agropecuaria", 
    "Artes Industriales", "Educación Física", "Religión", "Hogar", "Música", 
    "Artes Plásticas", "Informática Educativa", "Orientación"
  ], { required_error: "Debe seleccionar una materia oficial del MEP" }),
  
  level: z.string().regex(/^(7mo|8vo|9no|10mo|11mo|12mo|Primaria)$/, "Nivel inválido"),
  ...
  content: z.object({
    ...
    mediation: z.array(z.object({
      moment: z.enum(["1. CONEXIÓN", "2. COLABORACIÓN", "3. CONSTRUCCIÓN", "4. CLARIFICACIÓN"]),
