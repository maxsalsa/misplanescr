      ...
      <div className="card-body p-6">
          ...
          <table className="table table-zebra w-full table-compact">
            <thead>
              <tr>
                ...
                <th className="text-center font-bold bg-base-200">
                  Puntos Finales
                </th>
            ...
            <tfoot>
              <tr>
                ...
                <th className="text-center">
                  {indicators.reduce((a, b) => a + b.lessons, 0)}
                </th>
                <th></th>
        ...
        {viewMath && (
          <div className="alert alert-info mt-4 text-xs font-mono">
            <span className="font-bold">Fórmula MEP:</span> Puntos = Lecciones *
            (TotalPuntos / TotalLecciones). Redondeo &ge; 0.50 suben.
          </div>
        )}
      </div>
    </div>
