...
export function Sidebar() {
  ...
  const menuItems = [
    ...
    {
      name: "Crear Planeamiento",
      href: "/dashboard/create",
      icon: BookOpen,
      visible: true,
    },
    {
      name: "Evaluación (Test Maker)",
          ...
          <div className="flex flex-col gap-0 hover:bg-transparent cursor-default">
            <div className="flex items-center gap-3 text-white">
              ...
              <span className="text-2xl font-black tracking-tighter">
                AulaPlan<span className="text-blue-500">.cr</span>
              </span>
            </div>
              ...
              <ul className="pl-4 border-l-2 border-slate-800 mt-2 space-y-1">
                ...
                <li>
                  <Link
                    ...
                    className="text-slate-400 text-xs hover:text-white flex items-center justify-between"
                  >
                    Facturación
