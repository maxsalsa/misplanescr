    ...
    <div className="form-control w-full">
      ...
      {!file ? (
        ...
        >
          ...
          <p className="text-sm font-bold text-slate-700">Click para subir o arrastre aquí</p>
          <p className="text-xs text-slate-400 mt-1">Soporta: PDF, Excel, Word, Imágenes</p>
        </div>
      ) : (
        <div className="bg-white border border-slate-200 p-4 rounded-xl flex items-center justify-between shadow-sm">
           <div className="flex items-center gap-3">
              ...
              <div>
                 ...
                 <p className="text-xs text-slate-500">{(file.size / 1024).toFixed(1)} KB • Listo</p>
              </div>
           </div>
