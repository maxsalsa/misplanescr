...
export default function GardnerMatch({
  activityTitle,
  variants,
  students,
  onAssignToGroups,
  ...
  const groups = {
    LINGUISTICA: students.filter(
      (s) => s.dominantIntelligence === "LINGUISTICA",
    ),
    LOGICO_MATEMATICA: students.filter(
      (s) => s.dominantIntelligence === "LOGICO_MATEMATICA",
    ),
    VISUAL_ESPACIAL: students.filter(
      (s) => s.dominantIntelligence === "VISUAL_ESPACIAL",
    ),
    CINESTESICA: students.filter(
      (s) => s.dominantIntelligence === "CINESTESICA",
    ),
            ...
            return (
              ...
              >
                <div className="card-body p-4">
                  ...
                  <p className="text-sm italic opacity-75 line-clamp-3">
                    &quot;{v.instruction}&quot;
                  </p>

                  <div className="mt-4">
                    <div className="badge badge-primary">
                      {matchedStudents.length} Estudiantes
                    </div>
