...
const AcademicTemplate = ({ data, content }) => (
  <Document>
    <Page size="Letter" orientation="landscape" style={styles.page}>
      ...
      <Text style={styles.sectionTitle}>I. Habilidades en el marco de la Política Curricular</Text>
      <View style={styles.table}>
        <View style={styles.tableRow}>
          ...
          <View style={{...styles.cellHeader, width: "45%"}}><Text>Estrategias de Mediación</Text></View>
        </View>
...
const TechnicalTemplate = ({ data, content }) => (
  <Document>
    <Page size="Legal" orientation="landscape" style={styles.page}>
      ...
      <Text style={styles.sectionTitle}>Matriz de Planeamiento - Educación Técnica Profesional</Text>
      <View style={styles.table}>
        <View style={styles.tableRow}>
          <View style={{...styles.cellHeader, width: "20%"}}><Text>Resultado de Aprendizaje</Text></View>
          <View style={{...styles.cellHeader, width: "20%"}}><Text>Criterios de Desempeño</Text></View>
      ...
      <Text style={styles.footer}>
        Formato Oficial Educación Técnica | Enfoque por Competencias Laborales | AulaPlan Ultra
      </Text>
    </Page>
  </Document>
);
...
const AdultTemplate = ({ data, content }) => (
  <Document>
    <Page size="Letter" orientation="landscape" style={styles.page}>
      ...
      <View style={styles.table}>
        <View style={styles.tableRow}>
          <View style={{...styles.cellHeader, width: "20%"}}><Text>Módulo / Unidad</Text></View>
          <View style={{...styles.cellHeader, width: "25%"}}><Text>Aprendizaje por Lograr</Text></View>
          <View style={{...styles.cellHeader, width: "55%"}}><Text>Estrategias de Mediación (Contextualizadas)</Text></View>
        </View>
      ...
      <RubricGrid content={content} />
      <Text style={styles.footer}>Educación de Personas Jóvenes y Adultas (EPJA) | CINDEA / IPEC</Text>
    </Page>
  </Document>
);
...
export const PdfFactory = ({ modality, data, content }) => {
  ...
  if (data.level && (data.level.includes("Nivel") || data.subject.includes("Módulo"))) {
