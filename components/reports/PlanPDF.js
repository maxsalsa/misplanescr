    ...
    <Page size="LEGAL" orientation="landscape" style={styles.page}>
      ...
      {!isPremium && (
        <>
           ...
           <Text style={[styles.watermark, {top: 400, left: 300}]}>SUSCRÍBASE AL 6090-6359</Text>
        </>
      )}
      ...
      <View style={styles.header}>
        ...
        <Text style={{fontSize: 8, marginTop: 5}}>
           {isPremium ? "LICENCIA OFICIAL: MAX SALAZAR (PLAN ULTRA)" : "DOCUMENTO NO OFICIAL - VERSIÓN GRATUITA"}
        </Text>
      </View>
      ...
      <View style={styles.table}>
        <View style={styles.tableRow}>
          ...
          <View style={styles.tableCol}><Text style={styles.tableHeader}>Estrategias de Mediación</Text></View>
          <View style={styles.tableCol}><Text style={styles.tableHeader}>Técnicas de Evaluación</Text></View>
        </View>
        {content.map((row, i) => (
