    ...
    <Page size="LETTER" style={styles.page}>
      ...
      <View style={styles.header}>
        <View style={styles.titleSection}>
          ...
          <Text style={{ fontSize: 12, fontWeight: "bold", marginTop: 10 }}>
            PLANEAMIENTO DIDÁCTICO - {plan.subject.toUpperCase()}
          </Text>
        </View>
      </View>
      ...
      <View style={styles.adminTable}>
        ...
        <View style={styles.adminCol}>
          ...
          <Text style={styles.value}>
            {plan.content?.administrative?.period || "2026"}
          </Text>
        </View>
      ...
      <View style={styles.tableHeader}>
        <View style={styles.col1}>
          <Text style={styles.headerText}>APRENDIZAJES ESPERADOS</Text>
        </View>
        <View style={styles.col2}>
          <Text style={styles.headerText}>ESTRATEGIAS DE MEDIACIÓN (DUA)</Text>
        </View>
        <View style={styles.col3}>
          <Text style={styles.headerText}>INDICADORES DE EVALUACIÓN</Text>
        </View>
      </View>
      ...
      {plan.content?.mediation?.map((activity, index) => (
        <View key={index} style={styles.row}>
          ...
          <View style={styles.col2}>
            <Text
              style={{ ...styles.cell, fontWeight: "bold", marginBottom: 2 }}
            >
              {activity.moment}:
            </Text>
          ...
          <View style={styles.col3}>
            {index === 0 &&
              plan.content?.evaluation?.criteria?.map((c, i) => (
      ...
      <View style={styles.footer}>
        ...
        <View style={styles.signature}>
          <Text>Sello Dirección / Comité Evaluación</Text>
        </View>
      </View>
    </Page>
  </Document>
