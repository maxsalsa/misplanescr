            ...
            {type === "RUBRICA" ? (
                ...
                <div className="p-4 space-y-2">
                    ...
                    <div className="flex justify-between text-xs font-bold text-slate-400 uppercase px-2 mb-2">
                        ...
                        <span>Valoración ({type === "LISTA_COTEJO" ? "Sí/No" : "Escala"})</span>
                    </div>
                    {rows.map((row, i) => (
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 flex gap-3">
        ...
        <div>
            ...
            <p className="text-xs text-amber-700 mt-1">
                Según el Reglamento de Evaluación, no podrá asignar calificaciones a los estudiantes hasta que este instrumento esté guardado y validado.
            </p>
        </div>
      </div>
    </div>
