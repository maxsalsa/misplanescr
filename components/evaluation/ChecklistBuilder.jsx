  ...
  return (
    <div className="bg-white rounded-xl shadow border border-slate-200 overflow-hidden max-w-2xl mx-auto">
      ...
      <div className="p-2">
        ...
        <button
          onClick={addItem}
          className="mt-2 w-full py-2 border border-dashed border-slate-300 rounded text-slate-500 text-xs font-bold hover:bg-slate-50 hover:text-blue-600 transition-colors flex justify-center items-center gap-2"
        >
