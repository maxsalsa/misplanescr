        ...
        <div className="min-h-screen bg-slate-50 font-sans text-slate-800 flex">
            ...
            <aside className="w-20 lg:w-64 bg-[#003366] text-white flex flex-col transition-all h-screen sticky top-0">
                ...
                <nav className="flex-1 px-2 space-y-2 mt-4">
                    ...
                    <NavItem icon={<Award size={20} />} label="Gamificación" onClick={() => setActiveTab('gamification')} />
                ...
                <header className="bg-white border-b border-slate-200 px-8 py-4 flex justify-between items-center sticky top-0 z-10">
                    ...
                    <div className="flex gap-4">
                        <span className="badge badge-success gap-2">
                            <span className="w-2 h-2 rounded-full bg-green-600 animate-pulse"></span> Sistema en Línea
                        </span>
