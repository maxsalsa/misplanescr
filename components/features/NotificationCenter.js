...
export default function NotificationCenter() {
  ...
  const [notifications, setNotifications] = useState([
    {
      id: 1,
      text: "Bienvenido al Sistema V15",
      type: "info",
      time: "Hace 1 min",
    },
    {
  ...
  return (
    <div className="dropdown dropdown-end">
      ...
      {isOpen && (
        <ul
          tabIndex={0}
          className="mt-3 z-[1] p-2 shadow-2xl menu menu-sm dropdown-content bg-white rounded-xl w-80 border border-slate-100"
        >
          <li className="menu-title text-slate-400 uppercase text-xs font-bold px-4 py-2">
          ...
          <li className="mt-2">
            <button
              className="btn btn-xs btn-ghost text-slate-400 w-full"
