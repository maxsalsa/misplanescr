  ...
  const generateCapsule = () => {
    ...
    setTimeout(() => {
      setCapsule({
        ...
        action_item:
          "Esta noche, pregúntele a su hijo/a: ¿Qué necesitan las plantas de nuestro jardín para no morir?",
    ...
    <div className="card bg-gradient-to-br from-purple-50 to-indigo-50 border border-purple-100 shadow-sm">
      <div className="card-body">
        ...
        <p className="text-xs text-purple-700/70 mb-2">
          Transforma el tema <strong>&quot;{topic}&quot;</strong> en un mensaje
          simple para WhatsApp.
        </p>

        {!capsule && !loading && (
          <button
            className="btn btn-sm btn-outline btn-primary w-fit gap-2"
