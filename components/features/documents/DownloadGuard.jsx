  ...
  return (
    <>
      <div
        ...
        className={!premium ? "cursor-not-allowed opacity-80" : ""}
      >
        {children}
      </div>
        ...
        <div className="modal-box bg-slate-900 border border-slate-700 text-white">
          <div className="text-center">
            ...
            <p className="py-4 text-slate-400 text-sm">
              La descarga de PDFs Oficiales, Rúbricas Automatizadas e
              Instrumentos Sumativos es exclusiva para suscriptores{" "}
              <strong>AulaPlan PRO</strong>.
            </p>
            ...
            <div className="stats bg-slate-800 my-4 w-full">
              <div className="stat place-items-center">
                ...
                <div className="stat-value text-yellow-400 text-3xl">
                  ₡ 3,500
                </div>
