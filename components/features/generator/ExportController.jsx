      ...
      >
        <div className="modal-box border-2 border-primary bg-slate-900 text-white">
          ...
          <p className="py-4 text-lg text-slate-300">
            Estás a un paso de descargar planeamientos, rúbricas e indicadores
            de grado industrial.
            <strong> AulaPlan Premium</strong> desbloquea todas las
            especialidades.
          </p>
          <div className="bg-slate-800 p-4 rounded-xl mb-4 border border-dashed border-slate-700">
            <p className="text-sm opacity-70 text-slate-400">
              Pago Único mediante SINPE Móvil:
            </p>
            <p className="text-xl font-mono font-bold tracking-widest text-emerald-400">
              6090-6359
            </p>
            <p className="text-xs mt-1 text-slate-500 font-bold">
              A nombre de: Max Salazar Sánchez
            </p>
            <p className="text-xs mt-2 text-yellow-500/80">
              Envíe comprobante al WhatsApp del mismo número.
            </p>
          </div>
          <div className="modal-action">
            <form method="dialog">
              <button className="btn btn-ghost hover:bg-slate-800">
                Cerrar
              </button>
            </form>
          </div>
