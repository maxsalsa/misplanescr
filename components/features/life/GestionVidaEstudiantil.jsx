      ...
      <header className="max-w-7xl mx-auto flex justify-between items-center mb-10 bg-slate-800 p-6 rounded-[32px] border border-white/5 shadow-2xl">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[10px] font-bold opacity-50 tracking-widest text-slate-300">
              Gesti&oacute;n de Grupo | AulaPlan v5.0
            </p>
          </div>
        </div>
        {isDocenteGuia && (
      ...
      <main className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <section className="lg:col-span-2 space-y-6">
          <div className="bg-slate-800 rounded-[42px] p-8 border border-white/5 shadow-2xl relative overflow-hidden">
            ...
            <h2 className="text-lg font-black mb-6 uppercase text-slate-200">
              Control de Asistencia & Conducta
            </h2>
              ...
              <table className="table w-full">
                ...
                <tbody className="text-sm">
                  <tr className="hover:bg-white/5 transition-colors border-b border-white/5">
                    ...
                    <td>
                      <span className="badge badge-ghost text-[10px] uppercase font-bold text-slate-400">
                        Sin incidentes
                      </span>
                    </td>
                    <td>
                      <button
                        onClick={() =>
                          registrarBoleta("Max", "Porta un arma de fuego")
                        }
                  ...
                  <tr className="hover:bg-white/5 transition-colors border-b border-white/5">
                    ...
                    <td>
                      <button
                        onClick={() =>
                          registrarBoleta("Sofia", "Llegada tardía")
                        }
                        className="btn btn-ghost btn-xs text-error hover:bg-error/10"
                      >
                        <ShieldAlert size={16} />
            ...
            <div className="space-y-4">
              ...
              <div className="alert bg-black/20 text-[10px] border-none">
                ...
                <span className="opacity-60 italic">
                  *Bloqueo Antigravity: No se permite guardar notas sin
