...
export default function SchoolProfileConfig() {
  ...
  const [logoPreview, setLogoPreview] = useState(
    "https://placehold.co/100x100/e2e8f0/64748b?text=LOGO",
  );
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-4">
            <div className="form-control">
              ...
              <input
                type="text"
                placeholder="Ej: CTP de Inteligencia Artificial"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="form-control">
                <label className="label">
                  <span className="label-text">Dirección Regional (DRE)</span>
                </label>
                <input
                  type="text"
                  placeholder="Ej: San José Norte"
                  className="input input-bordered"
                />
              </div>
              <div className="form-control">
                <label className="label">
                  <span className="label-text">Circuito Escolar</span>
                </label>
                <input
                  type="text"
                  placeholder="Ej: 05"
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs uppercase tracking-wide">
                Dirección Regional de San José Norte | Circuito 05
              </p>
              <p className="text-sm font-bold mt-1">
                CTP DE INTELIGENCIA ARTIFICIAL
              </p>
            </div>
          </div>
