...
export default function CopilotWidget() {
  ...
  const [messages, setMessages] = useState([{ role: "ai", text: "Hola, soy Antigravity. ¿En qué te ayudo con tu planeamiento hoy?" }]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { role: "ai", text: "Error de conexión con el núcleo." }]);
    } finally {
      setLoading(false);
    }
  };
