                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="form-control">
                                ...
                                <input {...register("materia")} type="text" placeholder="Ej" className="input input-bordered w-full focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all" required />
                            </div>
                            <div className="form-control">
                        ...
                        <div className="form-control">
                            ...
                            <input {...register("unidad")} type="text" placeholder="Ej Contable de Servicios" className="input input-bordered w-full focus:border-indigo-500 transition-all" required />
                        </div>
