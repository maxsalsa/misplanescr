...
export async function getDashboardStats() {
    ...
    // Nota estamos iniciando, es posible que no haya muchos datos,
    // pero la consulta debe ser real.

    const studentsCount = await db.user.count({
        where: {
            role: 'ESTUDIANTE',
            // TODO por relación con el docente en tabla futura 'Enrollment'
        }
    });
...
export async function getUserProfile() {
    ...
    return {
        ...
        institution: 'MEP Costa Rica', // TODO in DB
