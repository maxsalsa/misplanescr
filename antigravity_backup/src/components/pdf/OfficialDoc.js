    ...
    <div className="hidden print:block w-full max-w-[21cm] mx-auto bg-white p-8 text-black">
      ...
      <div className="flex items-center justify-between border-b-2 border-black pb-4 mb-6">
        ...
        <div className="text-center">
          <h1 className="text-lg font-bold uppercase">Ministerio de Educación Pública</h1>
          <h2 className="text-sm font-bold uppercase">Dirección Regional {user?.regional || "_______"}</h2>
