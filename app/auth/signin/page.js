      ...
      <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md border border-slate-100 relative z-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">
            AULAPLAN <span className="text-blue-600">MEP</span>
          </h1>
          <p className="text-slate-500 text-sm mt-2">
            Plataforma de Inteligencia Curricular
          </p>
        </div>
        ...
        <div className="space-y-4">
          <button
            onClick={() =>
              signIn("google", { callbackUrl: "/dashboard/library" })
            }
          ...
          >
            <div>
              ...
              <div className="relative">
                <input
                  type="email"
                  defaultValue="max@misplanescr.com"
                  className="w-full bg-slate-50 border border-slate-200 rounded-lg p-3 text-sm font-medium focus:ring-2 focus:ring-blue-500 outline-none pl-10"
                />
                <Lock
            ...
            <button
              type="submit"
              className="w-full bg-slate-900 text-white p-3 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-blue-600 transition-colors shadow-lg shadow-blue-900/20"
            >
