...
export default function GeneratorAIConfig({
    ...
    return (
        <div className="card glass-card p-4 md:p-8 animate-fade-in border-2 border-indigo-100 shadow-xl" role="region" aria-label="Configuración de Inteligencia Artificial">
            <div className="flex flex-col md:flex-row justify-between items-start mb-6">
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1 max-w-lg">
                        Sube el <b>Programa de Estudio Oficial (PDF)</b> y define la unidad. El sistema analizará la normativa para generar un planeamiento ético y alineado.
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="form-control md:col-span-2 p-6 bg-slate-50 rounded-xl border border-dashed border-slate-300 hover:border-indigo-400 transition-colors">
                    ...
                    <div className="flex justify-between items-center mt-2">
                        <p className="text-xs text-slate-400">Puede seleccionar múltiples archivos (Progama, Reglamento, Circulares).</p>
                ...
                <div className="form-control">
                    <label className="label font-bold text-slate-600">
                        ...
                        <span className="tooltip tooltip-right" data-tip="Ej: Gestión Bancaria o Matemáticas">❓</span>
                    </label>
                    <input
                        type="text"
                ...
                <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-indigo-50/50 rounded-xl border border-indigo-100">
                    ...
                    <div className="form-control">
                        <label className="label font-bold text-indigo-800 text-xs uppercase tracking-wider">8. Grupo / Sección</label>
                        <input
                            type="text"
                            placeholder="Ej: 10-2"
                ...
                <div className="form-control md:col-span-2 p-6 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl border border-indigo-100">
                    <label className="label font-bold text-indigo-900 mb-2">
                        <span className="flex items-center gap-2">
                            <span className="text-xl">🧬</span> 9. Nivel de Innovación (Variabilidad)
                        </span>
                        <span className="badge badge-primary badge-outline text-xs">Anti-Repetición</span>
                    </label>
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        {[
                            { id: 'estandar', icon: '🛡️', title: 'Estándar', desc: 'Apego oficial estricto.' },
                            { id: 'creativo', icon: '🎨', title: 'Lúdico', desc: 'Gamificación y juegos.' },
                            { id: 'innovador', icon: '🚀', title: 'A.B.P.', desc: 'Enfoque de Proyectos.' },
                            { id: 'disruptivo', icon: '💥', title: 'Disruptivo', desc: 'Debates y Retos.' }
                        ].map((mode) => (
                            <div
                                key={mode.id}
