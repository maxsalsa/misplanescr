    ...
    <div className="card glass-card p-4 md:p-8 animate-fade-in border-2 border-pink-100 shadow-xl">
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-500 mt-1">
          Convierte cualquier texto (Plan, Unidad o Tema) en un recurso listo
          para usar.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="form-control md:col-span-2">
          ...
          <textarea
            ...
            onChange={(e) =>
              setConfigRecurso({ ...config_recurso, contexto: e.target.value })
            }
          />
        ...
        <div className="form-control">
          ...
          <select
            ...
            onChange={(e) =>
              setConfigRecurso({ ...config_recurso, tipo: e.target.value })
            }
          >
        ...
        <div className="form-control">
          ...
          <select
            ...
            onChange={(e) =>
              setConfigRecurso({ ...config_recurso, nivel: e.target.value })
            }
          >
