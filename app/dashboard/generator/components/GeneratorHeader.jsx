...
export default function GeneratorHeader({ activeInstitution, modoOperativo }) {
  const getModeTitle = () => {
    switch (modoOperativo) {
      case "clasico":
        return "Basado en plantillas precargadas.";
      case "recursos":
        return "Generador de Material Didáctico y Evaluación.";
      case "ia_normativa":
      default:
        return "Inteligencia Artificial Normativa (MEP-PLANNER).";
    }
  };
  ...
  return (
    <div className="text-center md:text-left">
      ...
      <p className="text-sm md:text-base text-slate-500">{getModeTitle()}</p>
    </div>
  );
}
