  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      <div className="flex justify-between items-end">
        <div>
            <h1 className="text-3xl font-black text-slate-900 tracking-tight">Centro de Evaluación</h1>
            <p className="text-slate-500">Diseño técnico de pruebas y balanceo de puntajes (Reglamento de Evaluación).</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                <h3 className="font-bold text-slate-700 mb-4 text-sm">Distribución Cognitiva</h3>
                <div className="space-y-2 text-xs">
                    ...
                    <div className="flex justify-between pt-2"><span className="text-slate-500">Aplicación</span> <span className="font-bold">50%</span></div>
                    <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden"><div className="bg-blue-500 h-full w-[50%]"></div></div>
                    
                    <div className="flex justify-between pt-2"><span className="text-slate-500">Análisis</span> <span className="font-bold">30%</span></div>
