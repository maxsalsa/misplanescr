...
export default function GradebookPage() {
    ...
    const MOCK_STUDENTS = [
        { id: 's1', name: 'Ana Gutiérrez', scores: { c1: 3, c2: 3, c3: 3 }, finalGrade: 100 },
        { id: 's2', name: 'Carlos Pérez', scores: { c1: 2, c2: 2, c3: 1 }, finalGrade: 65 },
        { id: 's3', name: 'María Rodríguez', scores: { c1: 3, c2: 3, c3: 2 }, finalGrade: 90 },
    ];
