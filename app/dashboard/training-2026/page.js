...
export default function Training2026Page() {
  ...
  const officialCourses = [
    { id: 1, name: "Introducción a la IA moderna", provider: "CISCO / NetAcad" },
    { id: 2, name: "Descubriendo el Emprendimiento", provider: "CISCO / NetAcad" },
    { id: 3, name: "Conciencia sobre seguridad y protección digital", provider: "CISCO / NetAcad" },
    { id: 4, name: "Introducción a la Ciencia de Datos", provider: "CISCO / NetAcad" },
    { id: 5, name: "Introducción a Ciberseguridad", provider: "CISCO / NetAcad" },
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in pb-20">
      ...
      <div className="bg-blue-50 border border-blue-200 p-6 rounded-xl flex gap-4">
        ...
        <div>
           <h1 className="text-2xl font-black text-slate-900">Jornada de Formación 2026</h1>
           <p className="text-slate-600 text-sm mt-1">
             Del <strong>9 al 20 de febrero</strong>. Registre aquí sus cursos de autoformación para cumplir con la circular <strong>DM-CIR-001-2026</strong>.
           </p>
        </div>
      </div>
        ...
        <div className="space-y-4">
           <div className="card-solemn p-6 bg-slate-900 text-white border-none">
              ...
              <p className="text-xs text-slate-400 mt-4 flex items-start gap-2">
                 ...
                 Recuerde que esta formación es obligatoria para todo el personal (Títulos I y II).
              </p>
           </div>
           ...
           <div className="card-solemn p-6">
              ...
              <ul className="text-sm space-y-2">
                 <li><a href="https://matriculaidp.mep.go.cr/cursosidp/" target="_blank" className="text-blue-600 hover:underline flex items-center gap-2">👉 Matrícula IDP</a></li>
                 <li><a href="https://www.netacad.com" target="_blank" className="text-blue-600 hover:underline flex items-center gap-2">👉 CISCO NetAcad</a></li>
              </ul>
           </div>
        </div>
      </div>
