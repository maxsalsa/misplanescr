      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-slate-500">
            Gestión centralizada de recursos didácticos.
          </p>
        </div>
        <Link
          href="/dashboard/generator"
          className="btn btn-institutional gap-2 shadow-lg shadow-blue-500/20"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {plans.map((plan) => (
            <Link
              ...
              className="card-solemn p-6 hover:shadow-xl transition-all group cursor-pointer relative overflow-hidden bg-white"
            >
