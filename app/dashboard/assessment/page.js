...
export default function AssessmentPage() {
  ...
  const handleGenerate = () => {
    if (error) {
      toast.error("Error de Validación", { description: "Corrija los campos en rojo antes de continuar." });
      return;
    }
    ...
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in pb-20 pl-4">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
           ...
           <p className="text-slate-500">Generación de pruebas con validación matemática estricta.</p>
        </div>
      </div>
