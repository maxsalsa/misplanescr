...
export default async function InstrumentsPage() {
  ...
  const indicators = lastPlan?.content?.evaluation?.criteria?.map(c => c.indicator) 
    || ["Aplica las normas de seguridad en el taller.", "Utiliza el equipo de protección personal correctamente."];
    ...
    <div className="p-8 max-w-6xl mx-auto space-y-8">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-slate-500 max-w-2xl">
            Herramienta técnica para la creación de Rúbricas, Listas de Cotejo y Escalas. 
            Cumple con el REA para la evaluación del Trabajo Cotidiano y Proyectos.
        </p>
      </div>
