...
function SubmitBtn() {
  ...
  return (
    <button
      disabled={pending}
      className="btn btn-primary w-full shadow-lg shadow-blue-900/10"
    >
  ...
  return (
    ...
    >
      <div className="form-control">
        <label className="label text-xs uppercase font-bold text-slate-500">
          Tipo de Trámite
        </label>
