        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-blue-200 mt-2 max-w-2xl">
              Registre aquí su participación en las jornadas de febrero
              (DM-CIR-001-2026). Esta evidencia digital respalda su expediente
              ante la Dirección.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 card-solemn p-8">
          <h3 className="font-bold text-slate-900 mb-6 flex items-center gap-2">
            <BookOpen size={20} className="text-blue-600" /> Inclusión de
            Actividad Formativa
          </h3>
          <form className="space-y-6">
            <div className="form-control">
              ...
              <span className="text-[10px] text-slate-400 mt-1">
                Oferta académica validada IDP/CISCO 2026
              </span>
            </div>
            ...
            <button className="btn btn-institutional w-full">
              Consignar en Expediente Digital
            </button>
          </form>
        </div>
        ...
        <div className="space-y-6">
          <div className="card-solemn p-6 bg-blue-50 border-blue-100">
            ...
            <p className="text-xs text-blue-700 mt-2">
              Recuerde completar los cursos de autoformación si tiene lecciones
              libres.
            </p>
          </div>
