        ...
        <div className="min-h-screen bg-slate-50 p-6 md:p-12 font-sans">
            <header className="max-w-4xl mx-auto mb-12 text-center md:text-left">
                ...
                <p className="text-xl text-slate-500 max-w-2xl">
                    Visualización quirúrgica de los datos extraídos por el <strong>Motor de Inteligencia Colectiva</strong>.
                    Aquí convergen la normativa legal, la neurociencia (DUA) y el stack tecnológico.
                </p>
            </header>
                ...
                {curriculumData && curriculumData.length > 0 ? (
                    ...
                    <div className="card bg-white p-12 text-center border border-dashed border-slate-300">
                        ...
                        <p className="text-slate-500 mt-2">
                            El &quot;Architect Engine&quot; está procesando los documentos PDF en segundo plano. <br />
